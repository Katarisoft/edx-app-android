...
public interface Analytics {
     ...
     *
     * @param courseId          Id of the course
     * @param blockId           Id of the non-supported xBlock.
     * @param isSpecialExamInfo Whether the block is special exam info ot not
     */
    void trackSubsectionViewOnWebTapped(@NonNull String courseId, @NonNull String blockId, boolean isSpecialExamInfo);
